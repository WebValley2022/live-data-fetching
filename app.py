...
def add_sensor_data():
    ...
    if request.method == 'GET':
        ...
        'timestamp': 1659106708162, 'node_id': 'appa1-mariolino'}
        ...
        # pg.upsert("packet", {
        #             "node_id": node_id,
        #             "sensor_ts": datetime.fromtimestamp(packet["timestamp"] / 1000.0), # TODO: convert into right datetime format
        #             # "attrs": ... , 
        #         }, [])
        ...
        attrs = json.dumps({})
        packet_id = pg.fetchone("insert into packet(node_id, sensor_ts) values (%s, %s, %s) returning id", [node_id, sensor_ts, attrs])
        
        print("SENSORS IDS", sensor_ids)
...
def add_node_info():
    ...
    if request.method == 'GET':
        ...
        pg.close()
        return "Hello node! /nodeinfo called"
    content = request.json
    logging.warning(content)
    return content
